const App = {
    ...
    config: {
        AWS_videoURL_Base: "https://agsdentistry02.s3.us-east-1.amazonaws.com/assets/videos/interaction/",
...
async playVideoNow(videoUrl) {
    ...
    async sendMessage() {
        ...
        try {
            const response = await fetch(this.config.ENDPOINT_URL + "agsvh/case2/chat_exact", {
                method: "POST",
...
playAudioReply() {
    ...
    async createLogFile() {
        const formUrl = "https://docs.google.com/forms/d/e/1FAIpQLSfzN7ZjEijPwxb99jzGsj0q3NFo7AbANJG4kPxRWF69dVK5QA/formResponse";
        const fieldIds = {
